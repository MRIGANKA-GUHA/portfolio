...
const Contact = () => {
    ...
    return (
        <div id="contact" className="min-h-screen w-screen flex items-center justify-center bg-gradient-to-br from-[#181c2b] via-[#23293a] to-[#3730a3] px-2 py-10 relative overflow-hidden">
            ...
            >
                ...
                <p className="text-base text-indigo-100 mb-8 text-center opacity-90 animate-contact-fadein" style={{ animationDelay: "0.15s" }}>
                    Excited to collaborate? Let’s get in touch!
                </p>
                <form className="w-full flex flex-col gap-6 animate-contact-fadein" style={{ animationDelay: "0.25s" }}>
                    <div>
                    ...
                    <button
                        type="submit"
                        className="mx-auto mt-4 px-8 py-2 rounded-lg bg-[#23293a] text-white font-semibold shadow hover:bg-[#3730a3] transition"
                    >
                        Submit
                    </button>
                </form>
                
                <div className="flex gap-4 mt-8 animate-contact-fadein" style={{ animationDelay: "0.4s" }}>
                    <a
                        href="https://instagram.com/mriganka.guha"
                        target="_blank"
                    ...
                    <a
                        href="https://linkedin.com/in/mriganka-guha-7444651b5"
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    <a
                        href="https://github.com/MRIGANKA-GUHA"
                        target="_blank"
                        rel="noopener noreferrer"
            ...
            <style>
                ...
                .animate-contact-fadein {
                    opacity: 0;
                    animation: contactFadeIn 1.1s cubic-bezier(.4,0,.2,1) forwards;
                }
                .contact-card-visible .animate-contact-fadein {
                    opacity: 1;
                }
